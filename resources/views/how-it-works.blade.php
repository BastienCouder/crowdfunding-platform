...
<section class="relative mb-12">
    <div class="relative rounded-lg mx-6 overflow-hidden">
        <img src="{{ asset('images/hands.jpg') }}" alt="Collaboration et financement" class="w-full h-[220px] md:h-[300px] object-cover">
        <div class="absolute inset-0 bg-gray-800/40"></div>
        <div class="absolute inset-0 flex flex-col justify-center px-8 md:px-12">
            <h1 class="text-white text-4xl md:text-5xl font-bold mb-4">Comment ça fonctionne</h1>
            <p class="text-white text-xl md:text-2xl font-medium max-w-2xl">Découvrez comment Fund connecte les porteurs de projets avec les contributeurs pour donner vie aux idées innovantes.</p>
        </div>
    </div>
</section>
