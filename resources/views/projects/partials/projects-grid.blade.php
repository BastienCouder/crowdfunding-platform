@forelse ($projects as $project)
            ...
            @empty
                ...
                <div class="col-span-1 md:col-span-2 lg:col-span-3 bg-white rounded-xl shadow-sm p-12 text-center border border-gray-100">
                    ...
                    <a href="{{ route('projects.create') }}" class="inline-flex items-center px-4 py-2 bg-lime-500 hover:bg-lime-600 text-fg font-medium rounded-full transition-colors shadow-sm">
