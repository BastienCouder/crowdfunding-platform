<x-app-layout>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Gérez vos projets et suivez vos statistiques</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $totalContributors }}</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div class="flex items-center">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Implémentez ici la logique de filtrage et de tri
            // Cette partie nécessiterait du JavaScript plus complexe ou idéalement
            // une requête AJAX vers le backend pour filtrer les données
        });
    </script>
</x-app-layout>
