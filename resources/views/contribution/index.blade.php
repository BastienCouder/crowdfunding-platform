    ...
    <x-dashboard-sidebar>
        <div class="py-8">
            ...
            <div class="mt-4 md:mt-0">
                <a href="{{ route('projects.index') }}" class="inline-flex items-center px-4 py-2 bg-lime-300 hover:bg-lime-500 text-fg font-medium rounded-full transition-colors shadow-sm">
