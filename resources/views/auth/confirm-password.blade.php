            ...
            <div class="mt-8 bg-white py-8 px-6 shadow sm:rounded-xl sm:px-10 border border-gray-100">
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="password" class="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-lime-500 focus:border-lime-500 focus:z-10 sm:text-sm" type="password" name="password" required autocomplete="current-password" />
